      ...
      <div className="w-full h-full flex flex-col md:flex-row items-center relative">
        ...
        >
          <div className="flex flex-col items-center text-white z-10 transform transition-transform duration-300 group-hover:-translate-y-2">
            ...
            <h2 className="text-3xl font-light mb-1 text-shadow">Admin Login</h2>
...
function AdminLoginForm({ isOpen, onClose }) {
  ...
  return (
    <div 
      className={`fixed inset-0 bg-white flex items-center justify-center transition-opacity duration-300 z-50 ${isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}
    >
     <Button 
  variant="ghost" 
  size="icon" 
